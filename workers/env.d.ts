/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/env.d.ts` (hash: e0faab32bd6b365fa994eef43a3df5b0)
// Runtime types generated with workerd@1.20260908.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	DB_NAME: SecretsStoreSecret;
	DB_USERNAME: SecretsStoreSecret;
	DB_PASSWORD: SecretsStoreSecret;
	JWT_SECRET: SecretsStoreSecret;
	ASSETS: Fetcher;
	DB_HOST: "miriax.ggc8ky5.mongodb.net";
	FRONTEND_URL: "https://miriaxone.com,https://www.miriaxone.com,https://miriaxone.pages.dev";
	MONGODB_URI: string;
	JWT_SECRET: string;
	BACKEND: DurableObjectNamespace<import("./src/index").MiriaxBackend>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MiriaxBackend";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DB_HOST" | "FRONTEND_URL" | "MONGODB_URI" | "JWT_SECRET">> {}
}
