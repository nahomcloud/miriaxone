...
export default function OneHome(){
  ...
  return <>
    ...
    <section className="one-footer-line"><div className="container"><b>MIRIAX ONE</b><span>� {new Date().getFullYear()}</span><Link to="/contact">Contact</Link><Link to="/login">Admin</Link></div></section>
  </>;
}
